...
class Quote{
	...
	public function bind(array $data) {
		...
		if (isset($data['thequote'])) {
			// is the bind from activerow or POST?
			$method = SomeRequest::getCmd('REQUEST_METHOD',null,'env');
			if (strtoupper( $method ) === 'POST') {
				$this->thequote = SomeRequest::getString("thequote","","post",JREQUEST_ALLOWHTML);	
			} else {
